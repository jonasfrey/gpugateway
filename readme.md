<!-- {"s_msg":"this file was automatically generated","s_by":"f_generate_markdown.module.js","s_ts_created":"Fri Dec 29 2023 02:04:47 GMT+0100 (Central European Standard Time)","n_ts_created":1703811887344} -->
...
```
## 6. data types...
when working with the cpu and gpu communicating with each other it is a bit difficult with datatypes
the following shows what is possible and what should be used
## 2. create a canvas
```javascript
